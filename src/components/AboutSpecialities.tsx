...
const AboutSpecialities = () => {
  return (
    <section className="container pl-3 md:pl-10 ">
      <h1 className="font-semibold text-5xl mb-10 text-center">
        Why Trust Our <br />{" "}
        <span className="text-[#1065dc]">Specialities?</span>
      </h1>
      <div className="p-5 grid  place-items-center md:grid-cols-3 grid-cols-1 gap-5">
        {specialities.map((speciality) => (
          <div key={speciality.title} className="flex flex-col justify-center mb-5 gap-5 bg-slate-900/10 p-5 rounded-lg">
            <p className="text-[#1065dc] text-left text-xl">
